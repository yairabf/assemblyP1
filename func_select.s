...
# sending the second pString #
  ...
  call printf
  addq    $4, %rsp
  popq    %r15                    #we restore r15 for the original value
  popq    %r14                    #we restore r14 for the original value
  popq    %r13                    #we restore r13 for the original value
  popq    %r12                    #we restore r12 for the original value
  ret
